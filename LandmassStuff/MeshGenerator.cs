...
public class MeshData {
    ...
    Vector3[] CalculateNormals() {
        ...
        // triangles stores sets of 3 vertices, so divide by 3 to get actual number of triangles;
        int triangleCount = triangles.Length / 3;

        for (int i = 0; i< triangleCount; i++) {
            //i is the number of triangle we're working with, i*3 is it's (start) reference in the triangle array
    ...
    // Calculates the cross product of AB and AC to get a surface normal
